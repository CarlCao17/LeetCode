...
func TestFindSmallestNumInRotateArray(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "corner case: rotate 4, non-strictly increasing",
			args: args{a: []int{3, 3, 1, 1, 2, 2}},
			want: 1,
		},
		{
			name: "corner case: rotate 5, non-strictly increasing",
			args: args{a: []int{3, 1, 1, 2, 2, 3}},
			want: 1,
		},
		...
		{
			name: "corner case: 10111",
			args: args{a: []int{1, 0, 1, 1, 1}},
			want: 0,
		},
		{
			name: "corner case: 11101",
			args: args{a: []int{1, 1, 1, 0, 1}},
			want: 1,
		},
	}
